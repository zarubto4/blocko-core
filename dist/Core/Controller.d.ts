...
export declare class Controller extends Events.Emitter<BlockAddedEvent | BlockRemovedEvent | ConnectionAddedEvent | ConnectionRemovedEvent> {
    ...
    registerExternalInputConnectorEventCallback(callback: (block: Block, event: ExternalConnectorEvent) => void): void;
    private externalOutputConnectorEventCallbacks;
    registerExternalOutputConnectorEventCallback(callback: (block: Block, event: ExternalConnectorEvent) => void): void;
    private inputConnectorEvent(connector, eventType, value);
    private outputConnectorEvent(connector, eventType, value);
    private externalInputConnectorEvent(block, event);
    private externalOutputConnectorEvent(block, event);
